...
```
                            ...
                            │  │  │                                                │ │
                            │  │  │   ┌────────────┐      ┌────────────────────┐   │ │
                            │  │  │   │Pushgateway │◀─────│ Scan Results       │   │ │
                            │  │  │   │  :9091     │ push │ (metrics)          │   │ │
                            │  │  │   └─────┬──────┘      └────────────────────┘   │ │
                            │  │  │         │ scrape                               │ │
                            │  │  │         ▼                                      │ │
                            │  │  │   ┌────────────────┐   ┌────────────────┐      │ │
                            │  │  │   │   Prometheus   │──▶│ AlertManager   │──────┼─┼──▶ EDA
                            │  │  │   │   (+ Rules)    │   │                │      │ │
                            │  │  │   └───────┬────────┘   └────────────────┘      │ │
                            │  │  │           │ query                              │ │
                            │  │  │           ▼                                    │ │
...
|------|------|----|-------------|
| 1 | Scan Playbook | Pushgateway | Push compliance metrics after scan |
| 2 | Scan Playbook | ConfigMaps | Store scan results for reports |
| 3 | Prometheus | Pushgateway | Scrape metrics every 30 seconds |
| 4 | Prometheus | AlertManager | Fire alerts when rules match |
| 5 | AlertManager | EDA | Send webhook with alert payload |
| 6 | Grafana | Prometheus | Query metrics for dashboards |
